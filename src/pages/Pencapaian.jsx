    ...
    <div className="w-full pb-6 font-sans">
      <div style={{ marginBottom: '16px' }}>
        ...
        <div style={{ fontSize: '13px', color: 'var(--slate)' }}>
          Raih lencana (badge) dengan menyelesaikan modul, simulasi, dan aktivitas Astromitigasi.
        </div>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[14px]">
        {/* Card 1 */}
        <div className="bg-white border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center relative overflow-hidden">
          ...
          <h3 className="text-[13px] font-bold text-brand-navy mb-1">Petualang Antariksa</h3>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center relative overflow-hidden">
          ...
          <h3 className="text-[13px] font-bold text-brand-navy mb-1">Diagnostician</h3>
        ...
        {/* Card 3 (Locked) */}
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">Pakar Cuaca Antariksa</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">Asteroid Defender</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">Debris Tracker</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">On Fire!</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">Mapper</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-[16px] flex flex-col items-center text-center opacity-80 relative overflow-hidden grayscale-[50%]">
          ...
          <h3 className="text-[13px] font-bold text-slate-700 mb-1">Astromitigasi Literate</h3>
